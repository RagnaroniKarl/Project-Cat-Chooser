...
ui <- fluidPage(theme = shinytheme("darkly"),
                ...
                tabsetPanel(type = "tab", 
                            ...
                            tabPanel("Adoption Center Near Me",
                                     ...
                                     br(),
                                     p("Below you will find a map with the locations of various adoption centers in the Geneva area. If you want to know more about a specific location, click on the icon and it will give you the localisation of the differents centers."),
                                     br(),
