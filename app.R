                  ...
                  mainPanel(
                    tabsetPanel(type = "tab", 
                                ...
                                tabPanel("Introduction", p("Welcome to our web application, your ultimate destination for everything cat-related."),
                                    ...
                                    br(), 
                                    p("One of the key features of our application is the ability to find cats available for adoption. We work closely with shelters and animal protection associations to help you find the perfect feline companion for your home. You can browse through our database of adorable cats, filter by breed, age, and location, and get in touch with the shelters to initiate the adoption process.", align = 'left', img(src = "kitten-adoption.jpg", height = 200, width = 200, align = 'right')),
