...
ui <- fluidPage(theme = shinytheme("darkly"),
                ...
                tabsetPanel(type = "tab", 
                            ...
                            tabPanel("Adoption Center Near Me",
                                     h3("This is where you can find Adoptions Centers near you.", style = "color:orange"),
                                     br(),
                                     p("Below you will find a map with the locations of various adoption centers in the Geneva area. If you want to know more about a specific location, click on the icon and it will give you the location of different adoption centers."),
                                     br(),
                                     ...
                                     p("Click on the link below to open Google Maps with all the information about adoption centers in the Geneva area."),
